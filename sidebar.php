  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <?php if(isset($_SESSION['login_type']) && $_SESSION['login_type'] == 1): ?>
        <img src="path_to_logo/home_logo.png" alt="Home Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <?php else: ?>
        <h3 class="text-center p-0 m-0"><b>Home</b></h3>
    <?php endif; ?>
</a>
    ...
    <div class="sidebar pb-4 mb-4">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="./index.php?page=calendar" class="nav-link nav-task_list">

      ...
      <form action="" id="login-form">
        ...
        <div class="row">
          <div class="col-8">
            <div class="">
              <label for="remember">
                Don't have an account? <a href="signup.php"><br>Sign Up Here</a>
              </label>
            </div>
          </div>
          <!-- /.col -->
...
$(document).ready(function(){
    $('#login-form').submit(function(e){
        ...
        if (!email.endsWith(emailDomain)) {
            ...
            $('#login-form').prepend('<div class="alert alert-danger">Please use an email address ending with @paragoniu.edu.kh.</div>');
            end_load();
            return;
        }
